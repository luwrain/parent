...
sh "if ! [ -d jre ]; then mkdir jre; docker run --rm -v /cache/jdk:/jdk -v /cache/jre:/jre ich777/winehq-baseimage bash -c \"cd /jdk/bin && wine jlink.exe --output Z:/jre --add-modules java.base\"; fi"
}
}
}
