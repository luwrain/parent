...
6, 200, End_track
7, 0, Start_track
7, 0, Instrument_name_t, "MIDI instrument 29"
7, 0, Program_c, 6, 29
7, 0, Note_on_c, 6, 39, 36
7, 5000, Note_off_c, 6, 39, 0
7, 5000, End_track
0, 0, End_of_file
EOF
...
sox $NAME.wav -c 1 .$NAME.wav && rm -f $NAME.wav && sox .$NAME.wav -c 2 -e float $NAME.wav && rm -f .$NAME.wav
sox $NAME.wav .$NAME.wav BASS 5 && rm -f $NAME.wav && mv .$NAME.wav $NAME.wav
sox $NAME.wav .$NAME.wav REVERB 20 && rm -f $NAME.wav && mv .$NAME.wav $NAME.wav
sox $NAME.wav .$NAME.wav FADE t 0 1.8 1.3 && rm -f $NAME.wav && mv .$NAME.wav $NAME.wav
sox --norm=-0.100 $NAME.wav .$NAME.wav && rm -f $NAME.wav && mv .$NAME.wav $NAME.wav
